...
private const val deprecationMessage = "Autogenerated for the plugin"

@Deprecated(level = DeprecationLevel.HIDDEN, message = deprecationMessage)
object UnitSerializer : KSerializer<Unit> {
    override val descriptor: SerialDescriptor = SerialDescriptor("kotlin.Unit", StructureKind.OBJECT)
    override fun serialize(encoder: Encoder, value: Unit) = encoder.encodeStructure(descriptor) {}
    override fun deserialize(decoder: Decoder): Unit {
        decoder.decodeStructure(descriptor) {}
        Unit // Workaround for JS bug
    }
}
